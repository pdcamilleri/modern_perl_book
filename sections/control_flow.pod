...
confusion. Consider a function C<topic_mangler()> that modifies C<$_> on purpose. If
...
new function call. The syntax is ugly, and confuses people who've heard "Never
use C<goto>", but it works:
